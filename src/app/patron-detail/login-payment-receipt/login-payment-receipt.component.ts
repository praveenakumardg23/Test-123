...
@Component({
  selector: 'app-login-payment-receipt',
  templateUrl: './login-payment-receipt.component.html',
  styleUrls: ['./login-payment-receipt.component.scss'],
})
export class LoginPaymentReceiptComponent implements OnInit {
